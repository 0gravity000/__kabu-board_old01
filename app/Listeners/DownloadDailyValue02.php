...
use App\Events\CheckDailyValue02;
...
class DownloadDailyValue02
{
     ...
     * Handle the event.
     *
     * @param  CheckDailyValue02  $event
     * @return void
     */
    public function handle(CheckDailyValue02 $event)
    {
        $meigaras = DB::table('meigaras')->orderBy('code')->where('code', '>=', 1828)
                                                        ->where('code', '<', 2004)->get();
